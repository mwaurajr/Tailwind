...
function Footer() {
  return (
    <div className='w-full mt-24 bg-gray-900 text-gray-300 px-2 py-2'>
        <div className='max-width-[1400px] m-auto grid grid-cols-2 md:grid-cols-6 border-b-2 border-gray-500 py-8 px-4'>
         <div>
         ...
         <div className='col-span-2 py-8 md:pt-2'>
            ...
            <p className='py-4'>The Latest deals, articles and resourses sent to your inbox weekly.</p>
            <form className='fle flex-col md:flex-col'>
                <input className='w-full p-2 rounded-md mb-4' type='email' placeholder='Enter Email...' />
                <button className='p-2 rounded-md mb-4'>Subscribe</button>
            </form>
         </div>
        </div>

        <div className='flex flex-col   max-w-[1400px] px-2 py-4 m-auto justify-between sm:flex-row text-center text-gray-500'>
            <p className='py-4'>2022. Jamuh ENT. All Rights Reserved </p>
